...
export class MainView extends React.Component {
  ...
  render() {
    ...
    if (registered) {
      return <RegisterView onRegister={(bool) => this.onRegister(bool)} />;
    }

    if (!user) return <LoginView onLoggedIn={user => this.onLoggedIn(user)} onRegister={(bool) => this.onRegister(bool)} />;
